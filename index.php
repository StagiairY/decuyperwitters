            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        <img src="images/part1/sixty-years-old-agronomist-inspecting-wheat-field-using-tablet-computer.jpg" alt="Afbeelding-farmer" class="img-fluid img-overlap">
                    </div>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-6 order-lg-2 mb-4 mb-lg-0">
                    <a data-fancybox href="#" class="video-1">
                        ...
                        <img src="images/part1/portrait-senior-hardworking-farmer-agronomist-corn-field-checking-crops-before-harvest.jpg" alt="Afbeelding" class="img-fluid">
                    </a>
                </div>
                <div class="col-lg-5 order-lg-1">
                    <h2 class="text-primary mb-4">Planten Verbeteren Je Leven</h2>
                    <p class="mb-4">Bij De Cuyper Witters geloven we dat planten niet alleen de schoonheid van je omgeving verhogen, maar ook je levenskwaliteit verbeteren. Onze passie voor groen inspireert ons om hoogwaardige planten en producten aan te bieden die bijdragen aan een gezondere en gelukkigere levensstijl.</p>
