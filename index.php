    ...
    <div class="site-section services-1-wrap">
        <div class="container">
            <div class="row mb-5 justify-content-center text-center">
                <div class="col-lg-7">
                    <h3 class="section-subtitle">Diensten</h3>
                    <h2 class="section-title mb-4 text-black">Verse Producten Elke Dag</h2>
                </div>
            </div>
            <div class="row no-gutters">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-1">
                        ...
                        <div class="service-1-icon">
                            <img src="images/part1/Icons/footprint.png" alt="Afbeelding-vogel-voetprint" class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-1">
                        ...
                        <div class="service-1-icon">
                            <img src="images/part1/Icons/shovel.png" alt="Afbeelding-schep-potgrond" class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-1">
                        ...
                        <div class="service-1-icon">
                            ...
                            <img src="images/part1/Icons/fertilizer.png" alt="Afbeelding-spray-fertilizer" class="img-fluid">
                        </div>
                        <div class="service-1-content">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-1">
                        ...
                        <div class="service-1-icon">
                            ...
                            <img src="images/part1/Icons/garden-tools.png" alt="Afbeelding-garden-tools" class="img-fluid">
                        </div>
                        <div class="service-1-content">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-1">
                        ...
                        <div class="service-1-icon">
                            <img src="images/part1/Icons/propane.png" alt="Afbeelding-propane-fles" class="img-fluid">
                        </div>
                        <div class="service-1-content">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-1">
                        ...
                        <div class="service-1-content">
                            ...
                            <p>Gravida sodales condimentum pellen tesq
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 ml-auto">
                        ...
                        <h2 class="section-title mb-4">More than <strong>50 year experience</strong> in agriculture
                            industry
                        </h2>
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-5 order-lg-1">
                    ...
                    <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim necessitatibus
                        placeat,
                        atque qui voluptatem velit explicabo vitae repellendus architecto provident nisi ullam minus
                        asperiores commodi! Tenetur, repellat aliquam nihil illo.</p>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="opacity-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt,
                        reprehenderit!</p>
                </div>
                <div class="col-lg-6">
