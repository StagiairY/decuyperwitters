    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <ul>
                ...
                <li>Eetbakken en drinkbakken met automatische vlotters</li>
                <li>Elektrische apparaten voor de stroomvoorziening op een draad, lint of koord rond uw weide</li>
                <li>...</li>
            </ul>
            <p>Wij hebben ook altijd een ruim assortiment houten palen in stock liggen:</p>
            <ul>
                <li>Groene geïmpregneerde palen: voor het gebruik in de tuin, weide of in een perkje</li>
